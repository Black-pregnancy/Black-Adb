"""
    ...
    Script : Black Adb - All in One Android Hacking ADB Toolkit  

    Copyright (C) 2024 Salvatore (github.com/Black-pregnancy)
    ...
    For any queries, Contact me at : salvatore77@protonmail.com
"""
...
menu1 = f"""
    ...
    {color.WHITE}[2]=> {color.GREEN}List Hacked    Devices       {color.WHITE}[7]=> {color.GREEN}Screen Record                        {color.WHITE}[12]=> {color.GREEN}Uninstall an App
    ...
    {color.WHITE}[5]=> {color.GREEN}Sccrenshare & Control Device {color.WHITE}[10]=> {color.GREEN}Run an App                          {color.WHITE}[15]=> {color.GREEN}Hack Device {color.RED}(Using Metasploit)
...
banner2 = f"""
              ⠀⣀⣀⣤⣤⣤⣤⡼⠀⢀⡀⣀⢱⡄⡀⠀⠀⠀⢲⣤⣤⣤⣤⣀⣀⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⣠⣴⣾⣿⣿⣿⣿⣿⡿⠛⠋⠁⣤⣿⣿⣿⣧⣷⠀⠀⠘⠉⠛⢻⣷⣿⣽⣿⣿⣷⣦⣄⡀⠀⠀⠀⠀⠀⠀⠀⠀  #Disclaimer Tool is Education Purpose only 
⠀⠀⠀⠀⠀⠀⢀⣴⣞⣽⣿⣿⣿⣿⣿⣿⣿⠁⠀⠀⠠⣿⣿⡟⢻⣿⣿⣇⠀⠀⠀⠀⠀⣿⣿⣿⣿⣿⣿⣿⣿⣟⢦⡀⠀⠀⠀⠀⠀⠀             @coded by Salvatore 
⠀⠀⠀⠀⠀⣠⣿⡾⣿⣿⣿⣿⣿⠿⣻⣿⣿⡀⠀⠀⠀⢻⣿⣷⡀⠻⣧⣿⠆⠀⠀⠀⠀⣿⣿⣿⡻⣿⣿⣿⣿⣿⠿⣽⣦⡀⠀⠀⠀⠀  
⠀⠀⠀⠀⣼⠟⣩⣾⣿⣿⣿⢟⣵⣾⣿⣿⣿⣧⠀⠀⠀⠈⠿⣿⣿⣷⣈⠁⠀⠀⠀⠀⣰⣿⣿⣿⣿⣮⣟⢯⣿⣿⣷⣬⡻⣷⡄⠀⠀⠀  
⠀⠀⢀⡜⣡⣾⣿⢿⣿⣿⣿⣿⣿⢟⣵⣿⣿⣿⣷⣄⠀⣰⣿⣿⣿⣿⣿⣷⣄⠀⢀⣼⣿⣿⣿⣷⡹⣿⣿⣿⣿⣿⣿⢿⣿⣮⡳⡄⠀⠀
...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣿⣿⣼⣀⣠⠂⠀
            ...
            {color.RED}{version}{color.WHITE}            {color.WHITE}By github.com/Black-pregnancy
"""
...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣿⣿⣼⣀⣠⠂⠀
           ...
           {color.RED}{version}{color.WHITE}               {color.WHITE}By github.com/Black-pregnanc
...
"""
"""
Copyright © 2024 Salvatore(github.com/Black-pregnancy)
"""
